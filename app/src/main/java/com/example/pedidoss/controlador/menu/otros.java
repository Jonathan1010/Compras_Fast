...
public class otros extends AppCompatActivity {
    ...
    private static final String[] OTRO = new String[]{
            "CARPINTERIA", "LAVADORA DE CARROS"
    };

    private static final String[] OTROMENU = new String[]{
            "LA MADERA DE JOSE", "LAVACOR", "ZONA LIMPIA"
    };
...
////// Aqui estamos llamando los capos de texto para luego seruna validacion que este llenos para avilitar el boton pagar///
        ...
        pagar.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent pagar= new Intent(otros.this, salirtodo.class);
                startActivity(pagar);
